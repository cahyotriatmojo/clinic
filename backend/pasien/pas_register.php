                ...
                <script>
                            setTimeout(function ()
                            {
                                swal("Success","<?php echo $success;?>","success").then(function() {
                                    window.location.href = 'add_poli.php';
                                });
                            },
                                100);
                </script>
                            ...
                            <div class="card-body p-4">
                                ...
                                <form  method='post'>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name= "nama_pas" placeholder="Enter your name" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="emailaddress">NIK</label>
                                        <input class="form-control" name="no_ktp" type="number" required placeholder="Enter your email">
                                    </div>
                                    <div class="form-group">
                                        <label for="password">NUMBER</label>
                                        <input class="form-control" name="no_hp" type="number" required placeholder="Enter your password">
                                    </div>

                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-primary btn-block" name="pasien_sup" type="submit"> Sign Up </button>
                                    </div>
