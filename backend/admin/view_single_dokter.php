                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Full Name :</strong> <span class="ml-2"><?php echo $row->doc_fname;?></span></p>
                                        ...
                                        <?php
                                            $poli_id = $row->poli_id;
                                            $ret_poli = "SELECT nama_poli FROM poli WHERE id=?";
                                            $stmt_poli = $mysqli->prepare($ret_poli);
                                            $stmt_poli->bind_param('i', $poli_id);
                                            $stmt_poli->execute();
                                            $res_poli = $stmt_poli->get_result();
                                            $row_poli = $res_poli->fetch_object();
                                        ?>
                                            <p class="text-muted mb-2 font-13"><strong>Poli :</strong> <span class="ml-2"><?php echo $row_poli->nama_poli;?></span></p>
                                        <?php
                                        ?>
