                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM pasien";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                    $stmt->bind_result($pasien);
                                                    $stmt->fetch();
                                                    $stmt->close();
                                                ?>
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $pasien;?></span></h3>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <?php
                                                $ret="SELECT * FROM pasien ORDER BY RAND() LIMIT 100 ";
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row->nama_pas;?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row->no_hp;?>
                                                    </td>
                                                    <td>
                                                        <?php echo date('d-m-Y H:i', strtotime($row->join_pas)); ?>
                                                    </td>
                                                    <td>
