                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method='POST' >
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="doc_email" type="email" id="emailaddress" required="" placeholder="Enter your doctor number">
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                               ...
                               <p class="text-white-50">Don't have an account? <a href="his_doc_register.php" class="text-white ml-1"><b>Sign Up</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
