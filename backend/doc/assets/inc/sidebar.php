                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="view_pasien.php">View Patients</a>
                                    </li>
                                    <li>
                                        <a href="manage_pasien.php">Manage Patients</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="add_jadwal_periksa.php">Add Jadwal Periksa</a>
                                    </li>
                                    <li>
                                        <a href="view_jadwal_periksa.php">View Jadwal Periksa</a>
                                    </li>
                                    <li>
                                        <a href="manage_jadwal_periksa.php">Manage Jadwal Periksa</a>
                                    </li>
